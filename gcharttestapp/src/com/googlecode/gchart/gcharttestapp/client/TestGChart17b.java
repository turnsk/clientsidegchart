...
// Tests bold, italic, color, fontsize hover annotation options.
public class TestGChart17b extends GChart {
   TestGChart17b() {
     ...
     setChartFootnotes(
"Check: point labels/hover annotation at x=1, 2, 3, 4 are in <br>" +
"normal, bold, italic, and bold-italic fonts, <br>" +
"are in colors: default, red, blue, and green<br>" + 
"and are in font sizes: default, default, 20px, 20px<bb>" + 
"hover annotations' upper left corners at upper left corners of symbols.");
